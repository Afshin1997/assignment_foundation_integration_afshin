...
"""autogenerated by genpy from tx_msgs/MotorState.msg. Do not edit."""
import codecs
import sys
...
class MotorState(genpy.Message):
  _md5sum = "9748b79b5db99e5564bd140a5cc6cee0"
  _type = "tx_msgs/MotorState"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# This is based on the sensor_msgs/JointState message, but also includes acceleration
...
string frame_id
"""
  __slots__ = ['header','name','position','velocity','acceleration','effort','Id_debug']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,name,position,velocity,acceleration,effort,Id_debug
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.Id_debug)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.Id_debug))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.Id_debug = s.unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.Id_debug.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.Id_debug = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
